...
import bc.payment.citypay.service.PaymentFinder;
import bc.payment.citypay.service.PaymentService;
...
public class PaymentResource {
	 ...
	 */
	@RequestMapping(value="payment_app.cgi", method = RequestMethod.GET)
	@ResponseBody
	 ...
	 */
	@RequestMapping(value="PayDayReport.html", method = RequestMethod.GET)
	@ResponseBody
	public String payDayReport(
		...
		return this.paymentFinder.findPayments(checkDateBegin, checkDateEnd).toString();
	}
