...
public class Request {
	...
	public static class Parameters{
		...
		public Parameters(int act, int agentCode, Date agentDate,
				String servCode, String account, int payAmount) {
			super();
			this.act = act;
		...
		public String toString() {
			return "Parameters [act=" + this.act + ", agentCode=" + this.agentCode + ", agentDate=" + this.agentDate + ", servCode="
					+ this.servCode + ", account=" + this.account + ", payAmount=" + this.payAmount + "]";
		}
