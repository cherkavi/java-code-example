...
public class Satellite {
	...
	public Satellite(int id, String name, String keyService, String keySatellite){
		this.id=id;
		this.name=name;
		this.key_for_service=keyService;
		this.key_for_satellite=keySatellite;
	}

	public Satellite(String name, String keyService, String keySatellite){
		this(0,name, keyService, keySatellite);
	}
	...
	public String toString() {
		return "Satellite [id=" + id + ", key_for_satellite="
				+ key_for_satellite + ", key_for_service=" + key_for_service
				+ ", name=" + name + "]";
	}
