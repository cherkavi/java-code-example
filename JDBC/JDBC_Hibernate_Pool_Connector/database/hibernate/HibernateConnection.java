...
public class HibernateConnection {
	 ...
	 * */
	public HibernateConnection(IConnector connectorFactory, 
							   String jdbcClassName, 
							   String hibernateDialect,Class<?> ... classes) throws Exception{
		this.connectorFactory=connectorFactory;
		sessionFactory=getAnnotationConfiguration(jdbcClassName, 
												  hibernateDialect,
