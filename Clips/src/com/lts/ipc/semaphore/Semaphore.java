...
public class Semaphore
{
	 ...
	 *        
	 * @deprecated Use {@link #connect(String, int)} instead of this method.
	 */
	public void connect(String name, int maxValue, int initialValue) throws IPCException
	{
		...
		SemaphoreNative.connect(result, name, maxValue, initialValue);
		...
		switch (result.result)
		{
			...
			case InsufficientPermissions:
				throw new IPCException(Messages.ERROR_PERMISSIONS);

			default:
				throw new IPCException(Messages.ERROR_UNKNOWN);
		}
