...
public class ResponseSettingsCatalog extends Function{
	 ...
	 */
	public ResponseSettingsCatalog(String path_to_directory,
	 ...
	 * @param unique_id - уникальное имя для данного процесса ( для объекта object_for_process)  
	 */
	public ResponseSettingsCatalog(String path_to_server,
	...
	protected Transport getFirstTransport() {
		Transport request=new Transport(new Task("CLIENT_RESPONSE_SETTINGS_CATALOG",
