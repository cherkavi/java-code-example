...
public class ResponseOperationCatalog extends Function{
	/** полный путь к каталогу, который нужно сохранить */
	private String field_path_to_directory;
	
	/**
	 * Послать информацию на сервер - имя каталога для хранения на клиенте отосланных на сервер файлов   
	 ...
	 */
	public ResponseOperationCatalog(String path_to_directory,
	 ...
	 * @param unique_id - уникальное имя для данного процесса ( для объекта object_for_process)  
	 */
	public ResponseOperationCatalog(String path_to_server,
	...
	protected Transport getFirstTransport() {
		Transport request=new Transport(new Task("CLIENT_RESPONSE_OPERATION_CATALOG",
