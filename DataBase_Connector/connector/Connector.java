...
public class Connector {
	...
	private static Class<?>[] classOfDatabase=new Class[]{Satellite.class,
			 SatelliteAlgorithmName.class,
			 SatelliteAlgorithmStep.class,
			 SatelliteClients.class,
			 SatelliteClientsArgus.class,
			 SatelliteClientsNsmep.class,
			 SatelliteClientsParameters.class,
			 SatelliteClientState.class,
			 SatellitePartnerOrder.class,
			 BankophoneListener.class,
			 BankophoneSender.class
	};
