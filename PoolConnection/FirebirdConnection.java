...
public class FirebirdConnection implements IConnector{
	...
	private String getDatabaseUrl(){
		if(this.pathToDatabase.indexOf(":firebirdsql:")>0){
			return this.pathToDatabase;
		}
        //String driverName = "org.firebirdsql.jdbc.FBDriver";
        String database_protocol="jdbc:firebirdsql://";
        String database_dialect="?sql_dialect=3&lc_ctype=WIN1251";
...
private Connection getConnectionToDatabase() {
	...
	try{
    	...
    	System.err.println("не удалось подключитьс€ к базе данных");
