...
@Entity
@Table(name="PROCESSOR_DESCRIBE")
public class ProcessorDescribe extends BaseDescribe{
	@Id
	@GeneratedValue(generator="generator",strategy=GenerationType.AUTO)
	@SequenceGenerator(name="generator",sequenceName="GEN_PROCESSOR_DESCRIBE_ID")
	@Column(name="ID")
	private int id;
	@Column(name="ID_MB")
