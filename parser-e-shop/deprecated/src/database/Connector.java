...
public class Connector {
	...
	private Class<?>[] classOfDatabase=new Class[]{
												   Mb.class,
												   MbDescribe.class,
												   MbDescribeName.class,
												   Hdd.class,
												   HddDescribe.class,
												   HddDescribeName.class,
												   Memory.class,
												   MemoryDescribe.class,
												   MemoryDescribeName.class,
												   Processor.class,
												   ProcessorDescribe.class,
												   ProcessorDescribeName.class,
												   Video.class,
												   VideoDescribe.class,
	...
	/** произвести соединение с базой данных посредством файла*/
	public Connector(String path, String user, String password) throws Exception {
		System.out.println("Connector created:");
		this.connector=new FirebirdConnection(path,user,password);
		hibernateConnection=new HibernateConnection("org.hibernate.dialect.FirebirdDialect",classOfDatabase);
	}
