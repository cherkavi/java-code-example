package database.serializer.pack;
...
import database.serializer.pack.column.IRecordColumn;

/** объект, который выдает очередную запись, по уникальному идентификатору */
public class PackRecordFactory {
	/** имя таблицы */
	 ...
	 * */
	public PackRecordFactory(String tableName, String primaryField, IRecordColumn ... columns){
	 ...
	 * */
	private String getValuesDelimeterComma(Integer[] values){
		if(values!=null){
	 ...
	 * */
	public RecordWrap getRecords(Connection connection, Integer ... idValues){
