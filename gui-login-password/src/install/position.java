...
public class position {
	...
	public static void set_frame_to_center(JInternalFrame internalFrame, JFrame frame) {
        internalFrame.setBounds((int)(((frame.getWidth()-internalFrame.getWidth())/2)), //-internalFrame.getWidth()/2 
                				(int)(((frame.getHeight()-internalFrame.getHeight())/2)), //-internalFrame.getHeight()/2 
                			    internalFrame.getWidth(),
                			    internalFrame.getHeight());
	}
