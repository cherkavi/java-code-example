...
*/
	...
	public static void main(String[] args){
		try{
			URLConnection connection=(new URL("http://copoka.com.ua")).openConnection();
			connection.setDoInput(true);
			//connection.setDoOutput(true);
			connection.connect();
			...
			FileOutputStream output=new FileOutputStream(new File("d:\\test2.html"));
			...
			*/
			cutBytes.copyFromInputToOutput(input, output);
