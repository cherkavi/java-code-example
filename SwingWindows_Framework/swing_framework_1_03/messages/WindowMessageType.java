...
public class WindowMessageType {
	...
	/** сообщение, которое адресовано родительскому окну new WindowMessage(PARENT_NOTIFIER, additionalIdentifier:null, argument:Object)*/
	public static final int PARENT_NOTIFIER=15;
	/** сообщение, которое адресовано данному окну, возможно, от родительского new WindowMessage(THIS_NOTIFIER, additionalIdentifier:null, argument:Object)*/
	public static final int THIS_NOTIFIER = 16;
	/** сообщение для родительского окна что какое-то дочернее сняло флаг модальности, и теперь родительское окно может создавать и другие модальные окна */
	public static final int CHILD_UNSET_MODAL = 17;
