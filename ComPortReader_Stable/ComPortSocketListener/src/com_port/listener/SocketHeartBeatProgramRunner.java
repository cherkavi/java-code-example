...
public class SocketHeartBeatProgramRunner extends Thread implements IWatchDogTimerNotify,IComPortListener{
	...
	private void runProgram(){
		try{
			...
			System.err.println("ConPortReaderController#runProgram: "+ex.getMessage());
		}
	}
