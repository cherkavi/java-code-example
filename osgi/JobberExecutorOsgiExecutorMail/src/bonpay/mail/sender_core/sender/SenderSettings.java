...
public class SenderSettings {
	...
	private String from;
	/** максимальное кол-во попыток отправки сообщения */
	private int maxAttemptError=0;
	 ...
	 * @param maxAttemptError - максимальное кол-во попыток отправки сообщения
	 */
	public SenderSettings(String from, String smtpServer, int smtpPort, String login, String password, boolean needAuthentification, long timeDelayMs,int maxAttemptError){
		this.from=from;
		...
		this.maxAttemptError=maxAttemptError;
	}
	...
	/** получить максимальное кол-во попыток отправки сообщения */
	public int getMaxAttemptError() {
		return maxAttemptError;
	}

	/** задать максимальное кол-во попыток отправки сообщения */
	public void setMaxAttemptError(int maxAttemptError) {
		this.maxAttemptError = maxAttemptError;
	}
