...
public class FrameMainFirebird extends JFrame{
	/** */
	...
	private void on_button_read_click(){
		...
		try{
            ...
            TableOne table_one=(TableOne)session.get(database.firebird.TableOne.class, new Integer(2));
