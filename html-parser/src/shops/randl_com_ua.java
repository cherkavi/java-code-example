...
public class randl_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		...
		try{
			...
			String priceElementText=priceElement.getTextContent().trim().toUpperCase().replaceAll("[,]", "").replaceAll("ÃÐÍ", "");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://randl.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://randl.com.ua";
	}
