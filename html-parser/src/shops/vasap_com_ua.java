...
public class vasap_com_ua extends TableSinglePage{
	...
	protected String getSectionNameFromRow(Node node) {
		return this.parser.getTextContentFromNodeAlternative(node, "td/b/a", "");
	}
	...
	protected String getFullHttpUrlToPrice() {
		return "http://vasap.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://vasap.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td[2]/div/div[3]/table/tbody/tr/td/span/center/table[2]/tbody";
	}
