...
public class video_ochki_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		...
		try{
			...
			Element priceElement=(Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/b/nobr");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://video-ochki.com.ua/shop/index.php?ukey=pricelist";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://video-ochki.com.ua";
	}
