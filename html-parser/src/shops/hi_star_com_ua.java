...
public class hi_star_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		...
		try{
			if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("Нет ")<0){
				...
				String priceElementText=priceElement.getTextContent().trim().toLowerCase().replaceAll("грн.",""). replaceAll("[$ а-я,]", "");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.hi-star.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.hi-star.com.ua/index.php";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table[2]/tbody/tr/td[3]/table/tbody/tr/td/table/tbody/tr/td/center/p[2]/table/tbody";
	}
