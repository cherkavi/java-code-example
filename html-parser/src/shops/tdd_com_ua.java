...
public class tdd_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		...
		try{
			...
			String priceElementText=priceElement.getTextContent().trim().replaceAll("[$ à-ÿ,]", "");
	...
	protected String getSectionNameFromRow(Node node) {
		return this.parser.getTextContentFromNodeAlternative(node, "/td[1]/a", "");
	}
	...
	protected String getFullHttpUrlToPrice() {
		return "http://tdd.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://tdd.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table[3]/tbody/tr/td[2]/div[2]/center/table[2]/tbody";
	}
}
