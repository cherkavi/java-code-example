...
public class _1Brovary_com_ua extends TableSinglePage{
	...
	protected String getDescription() {
		return "http://1brovary.com.ua";
	}

	@Override
	protected String getFullHttpUrlToPrice() {
		return "http://1brovary.com.ua/index.php?show_price=yes";
	}
	...
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[2]/tbody/tr/td[3]/div/center[2]/p[2]/table/tbody";
	}
	...
	protected String getSectionNameFromRow(Node node) {
		try{
			return ((Element)this.parser.getNodeFromNodeAlternative(node, "/td/a")).getTextContent();
		}catch(Exception ex){
