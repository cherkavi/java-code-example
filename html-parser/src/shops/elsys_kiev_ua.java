...
public class elsys_kiev_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.elsys.kiev.ua/index.php?show_price=yes";
	}
	...
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td[2]/table/tbody/tr[3]/td/table/tbody/tr/td[2]/center/p[2]/table/tbody";
	}
