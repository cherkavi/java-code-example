...
/**
 * OcCategoryToStoreId generated by hbm2java
 */
@Embeddable
public class CategoryToStoreId implements java.io.Serializable {

	private int categoryId;
	private int storeId;

	public CategoryToStoreId() {
	}

	public CategoryToStoreId(int categoryId, int storeId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CategoryToStoreId))
			return false;
		CategoryToStoreId castOther = (CategoryToStoreId) other;
