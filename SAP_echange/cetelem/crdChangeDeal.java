...
public class crdChangeDeal
  ...
  private Vector<Vector<Hashtable<String, String>>>
      changeDeal(Vector<Hashtable<String, String>> data) throws Exception {
    ...
    try {
      ...
      JCO.Function function = connector.getFunction("ZRTN_IMPORT_ADDINF_RFC");
...
//run crd
    crdChangeDeal crd = new crdChangeDeal();
