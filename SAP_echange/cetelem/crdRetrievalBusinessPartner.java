...
public class crdRetrievalBusinessPartner
  ...
  public crdRetrievalBusinessPartner() {
  }

  public Vector startProcessing(Vector dataIncoming) {
    log.info("Begin Retrieval Business Partner ");
    ...
    log.info("End Retrieval Business Partner ");
    return dataReturn;
  }
  ...
  private Vector<Vector<Hashtable<String, String>>>
    ...
    try {
      ...
      JCO.Function function = connector.getFunction("ZCML_GET_BP_RFC");
...
//run crd
    crdRetrievalBusinessPartner crd = new crdRetrievalBusinessPartner();
